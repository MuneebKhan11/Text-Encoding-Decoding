...
root.resizable(0, 0)
root.title("Text Cypher by Muneeb Khan")

Label(root, text='ENCODE / DECODE', font='Roboto 20').pack()
Label(root, text='Muneeb Khan', font='System 10 bold').pack(side=BOTTOM)
...
Label(root, font='Roboto 12', text='MODE(e for Encode/  d for Decode)').place(x=60, y=120)
